...
from networksecurity.entity.artifiact_entity import DataTransformationArtifact, DataValidationArtifact
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        """
        It initialises a KNNImputer object with the parameters specified in the training_pipeline.py file and returns a Pipleine object with the KNNImputer object as the first step.
